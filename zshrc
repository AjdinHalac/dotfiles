...
alias lol='WINEPREFIX=~/LoL32 wine "C:/Riot Games/League of Legends/LeagueClient.exe"'
...
c7edown(){
    docker-compose -f ~/Documents/Code/NSoft/Catalogue/c7e-si/docker-compose.yml down
    docker-compose -f ~/Documents/Code/NSoft/Catalogue/c7e-tp/docker-compose.yml down
